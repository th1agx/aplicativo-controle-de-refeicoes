...
export default function RegistroFreqManha({ navigation, route }) {
  ...
  const totalPresentesManha = totalPresentesCreche + totalPresentesPreEscola;
    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('RegRefeicoesManha', { selectedDate })}>
          <Image
      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.totalPresentes}>
          ...
          <Text style={styles.totalValor}>{totalPresentesManha}</Text>
        </View>
      </ScrollView>
    </View>
  );
